...
| 項目 | 內容 |
|---|---|
| 執行區間 | 2026-07-27 03:14–2026-08-11（v1.2.2 release 與 DOI closeout 完成） |
| 完成到 | **v1.2.2 已正式發布。** 所有研究與 GPU 階段完成；Phi seed-42 filtered LoRA、GitHub Release、software archive 與 Technical note 均已公開並完成匿名驗證 |
| 卡住的項目 | 無 |
...
**專案的 GPU、實驗與 v1.2.2 software publication closeout 全部完成。** M19 已補上原本 D-004
...
tracked technical report PDF 與 release checksums。v1.2.2 的 immutable Zenodo archive 是
[record 21879133](https://zenodo.org/records/21879133)，version DOI 為
[`10.5281/zenodo.21879133`](https://doi.org/10.5281/zenodo.21879133)；all-versions concept DOI
仍為 [`10.5281/zenodo.21767492`](https://doi.org/10.5281/zenodo.21767492)。

**v1.2.2 發布與保存已完成**（2026-08-11）：

| 項目 | 結果 |
|---|---|
| Annotated tag `v1.2.2` | 固定指向 `d9ea6bb4dd6c80c5c4f5aaa65ad81c1de45725e7`；tagger `kuotunyu`；舊 tags 未移動 |
| GitHub Release | [v1.2.2](https://github.com/kuotunyu/FormosaNLU-Synth/releases/tag/v1.2.2)，非 draft、非 prerelease，7 個下載後 hash-verified assets |
| Zenodo software archive | [record 21879133](https://zenodo.org/records/21879133)；version DOI [`10.5281/zenodo.21879133`](https://doi.org/10.5281/zenodo.21879133)；creator 僅 `kuotunyu` |
| Zenodo Technical note | [record 21879155](https://zenodo.org/records/21879155)；DOI [`10.5281/zenodo.21879155`](https://doi.org/10.5281/zenodo.21879155)；CC BY 4.0；3 個檔案匿名下載及 MD5 verified |
| Hugging Face | Dataset、Gemma 與 Phi cards 已同步；資料／weights file set、bytes 與 SHA-256 均未改變 |
...
### [2026-08-11] v1.2.2 release 與 DOI closeout — 完成
...
- Technical report 已以 Zenodo Technical note [record 21879155](https://zenodo.org/records/21879155)
  公開；與 software record 雙向連結，唯一 creator、CC BY 4.0、3 個檔案及匿名下載均通過 verifier
- 完成 GitHub／HF／Zenodo publication verifiers 的 v1.2.2 擴充；既有
  `v1.2.1` tag 仍固定指向 `1f42372e97c98212f192362ec441c034815b37d5`
- annotated tag 固定指向 `d9ea6bb4dd6c80c5c4f5aaa65ad81c1de45725e7`；GitHub Release 的 7 個 assets
  經下載重算後與 `SHA256SUMS.txt` 完全一致
- Zenodo 匿名驗證 record 21879133、DOI `10.5281/zenodo.21879133`、creator
  `kuotunyu` 與 GitHub tag commit 均正確
